...
다중상속(extends)이 불가능하므로 [interface](https://github.com/sehajyang/TIL/blob/master/Java/README.md#6-%EC%B6%94%EC%83%81-%ED%81%B4%EB%9E%98%EC%8A%A4abstract-class%EC%99%80-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4interface)를 사용해 다중상속을 한다.
